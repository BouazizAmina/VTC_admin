...
class vueClient{
    function getClientsVue(){
        $model = new ControllerClient();
        $cards = $model ->getClientController();
        ?>
        <table class="table table-striped">
            ...
            foreach($cards as $card){?>
                <tr>
                    ...
                    <td><?php
                    if($card ['banir'] != 1){?>
                        <h6><a class="btn btn-sm" href="modifClient.php?id=<?= $card['id_client'] ?>" id="" role="button">Banir</a></h6><?php
                    }if($card ['banir'] == 1){?>
                        <h6><a class="btn btn-sm" href="autoriserClient.php?id=<?= $card['id_client'] ?>" id="" role="button">Autoriser</a></h6>
                    <?php } ?></td>
                </tr><?php 
            } ?>
            </tbody>
    ...
    function table($cards){?>
        ...
        foreach($cards as $card){?>
            <tr>
                ...
                <td><?php
                    if($card ['banir'] != 1){?>
                        <h6><a class="btn btn-sm" href="modifClient.php?id=<?= $card['id_client'] ?>" id="" role="button">Banir</a></h6>
                    <?php } ?>
                </td>
            </tr><?php 
        } ?>
